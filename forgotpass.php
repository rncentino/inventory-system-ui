...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>
      Forgot Password - Store Inventory System
    </title>
    <link
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="mb-1">
                                ...
                                <input type="email" class="form-control" placeholder="Input your registered email" required id="email" aria-describedby="emailHelp">
                            </div>
                            <div class="text-center mb-1">
                                <button type="submit" class="btn btn-primary btn-lg" style="width: 100%;">Recover password</button><br><br><br>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                              <button class="btn btn-sm btn-secondary">
                                <a class="text-white" href="login.php">Return to Login</a>
                              </button>
                              <button class="btn btn-sm btn-secondary">
