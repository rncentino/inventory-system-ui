...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>
      Outcoming Items - Store Inventory System
    </title>
    <link
  ...
  >
    ...
    <!-- fixed-top-->
    <?php
include("include/outcoming-items/header.php");
    ?>
    <!-- fixed-top-->

    <!-- Sidebar -->
    <?php
include("include/outcoming-items/sidebar.php");
    ?>
    <!-- Sidebar -->
    ...
    <!-- Footer -->
    <?php 
include("include/outcoming-items/footer.php");
    ?>
    <!-- Footer -->
