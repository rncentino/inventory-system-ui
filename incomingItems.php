...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>
      Incoming Items - Store Inventory System
    </title>
    <link
  ...
  >
    ...
    <!-- fixed-top-->
    <?php
include("include/incoming-items/header.php");
    ?>
    <!-- fixed-top-->

    <!-- Sidebar -->
    <?php
include("include/incoming-items/sidebar.php");
    ?>
    <!-- Sidebar -->
    ...
    <!-- Footer -->
    <?php 
include("include/incoming-items/footer.php");
    ?>
    <!-- Footer -->
